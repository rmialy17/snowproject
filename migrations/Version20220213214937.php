 ...
 */
final class Version20220213214937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD username VARCHAR(15) NOT NULL, ADD pseudo VARCHAR(15) NOT NULL, ADD auteur VARCHAR(20) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire DROP username, DROP pseudo, DROP auteur, CHANGE contenu contenu LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
